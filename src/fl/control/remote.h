...
#include "fl/control/rpc/rpc.h"
#include "fl/control/rpc/rpc_mode.h"
#include "fl/control/rpc/server.h"
#include "fl/control/types.h"
...
public:
    ...
    using RpcResult = fl::RpcResult;      // from fl/control/types.h
    using ClearFlags = fl::RemoteClearFlags;    // from fl/control/types.h
    using MethodInfo = fl::MethodInfo;    // from fl/control/rpc/rpc.h
    using ParamInfo = fl::ParamInfo;      // from fl/control/rpc/rpc.h
